...
object BuildInfo {
  ...
  private case class BuildInfoTask(dir: File, obj: String, pkg: String,
    ...
    val tempFile = cacheDir / "sbt-buildinfo" / s"""$obj.scala"""
    ...
    def makeFile(file: File): File = {
      ...
      val lines =
        preamble :::
        List(s"""case object $obj {""") :::
        (distinctKeys flatMap { line }) :::
        List(toStringLines(distinctKeys)) :::
    ...
    def toStringLines(keys: Seq[BuildInfoKey]): String = {
